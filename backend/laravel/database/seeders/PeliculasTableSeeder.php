    ...
    class PeliculasTableSeeder extends Seeder {
        public function run(): void {
            $peliculas = [
                ...
                [ "nombre_pelicula" => "American Psico",          "disponible" => false,  "categoria_id" => 2, "data" => today(),    "descripcion" => "Un thriller psicológico que sigue a Patrick Bateman, un ejecutivo de Wall Street obsesionado con el éxito, la imagen y el materialismo, mientras lucha con su oscura y violenta naturaleza psicópata en la Nueva York de los años 80." ],
